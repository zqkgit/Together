...
const { getStudioWithdrawals, putStudioWithdrawalReview, putStudioDistributeRate } = require("../controllers/commissionController");
const { listWithdrawalsValidators, studioReviewValidators } = require("../validators/commissionValidator");
...
// 佣金（分销返利）：领取单审核 / 打款登记，以及工作室返利比例设置
router.get("/commissions", listWithdrawalsValidators, validateRequest, getStudioWithdrawals);
router.put("/commissions/:id", studioReviewValidators, validateRequest, putStudioWithdrawalReview);
